...
<body>
    <div class="sidebyside">
        <div class="sidebar">
            ...
            <form method="post" action="../logout.php">
                ...
                <div class="logout-button" style="display: flex">
                    <button type="submit" name="logout"><strong>LOGOUT</strong></button>

                    <button type="button" onclick="viewAllScores()"><strong>View All Scores</strong></button>
                </div>
    ...
    <script>
        function viewAllScores() {
            window.location.href = 'view_all_scores.php';
        }
    </script>
</body>
